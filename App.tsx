...
const App = () => {
  ...
  return (
    <div className={`w-full h-screen flex flex-col items-center py-6 px-4 select-none overflow-hidden transition-colors duration-300 ${state.theme === 'dark' ? 'bg-[#09090b] text-zinc-100' : 'bg-white text-zinc-900'}`}>
